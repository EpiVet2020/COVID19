...
Podemos ainda constatar um ligeiro aumento no número de casos durante os meses de verão, seguido de uma diminuição no final de agosto e início de setembro. Esta variação pode ser justificada na sequência do período de férias, que apesar das restrições impostas, leva sempre a um aumento das deslocações e um maior número de contacto entre pessoas.
...
<ul>
  ...
  <li>Regresso a uma vida mais normal com mais contactos entre pessoas e menos cuidados e preocupações que no início da pandemia</li>
</ul>

No gráfico da percentagem de testes positivos, é possível ver que, desde o início de setembro, tem havido um aumento na percentagem de casos positivos. No entanto, não é um aumento tão acentuado como aquele verificado neste gráfico da evolução da incidência. Isto indica-nos que, apesar de estar a haver um aumento no número de casos, está também a haver um aumento no número de testes realizados (o que está de acordo com o gráfico da evolução do número de testes realizados).
...
#### Número de Casos
<br>
Neste gráfico e mapa podemos ver que Lisboa e Vale do Tejo é a ARS com mais casos, seguindo-se a ARS Norte. Com menos casos, é de realçar as ARSs dos Açores e da Madeira que, com as estratégias implementadas para os turistas que obrigam a realização de um teste ao SARS-CoV-2 negativo até 72h antes da ida ou a realização do teste à chegada ao aeroporto, cumprindo o isolamento profilático até à recepção do resultado do mesmo, conseguiram limitar o aumento do número de casos. No entanto, temos de ter presente que este gráfico e mapa não têm em consideração a população de cada ARS.
...
Quanto às ARSs dos Açores e da Madeira, é notável a ausência quase total de novos casos durante os meses de maio e junho, resultado de uma testagem massiva com adequado controlo dos casos iniciais e da implementação de medidas contenção como a quarentena obrigatória e permissão exclusiva à entrada de residentes. A partir de julho, voltaram a surgir alguns casos devido ao levantamento da restrição à entrada de turistas. É de também de realçar que são as únicas ARSs que não tem sofrido um aumento desde setembro. 
...
A faixa etária dos 20 aos 29 anos é a que apresenta a segunda maior prevalência, sendo notório que este valor vai diminuindo à medida que a faixa etária envelhece, com exceção da faixa etária dos 80+, como explicado anteriormente. Isto pode dever-se ao aumento do receio da doença com o aumento da idade.
...
Neste gráfico de área podemos verificar que as faixas etárias entre os 0 e os 19 anos, apresentaram inicialmente um baixo número de novos casos diários. Nos meses de verão apresentaram um aumentado que se tornou mais expressivo a partir de setembro, o que poderá ser explicado pelo regresso dos estudantes às aulas e pelo regresso dos pais aos empregos.
