...
casos_regioes_grafico <- ggplot(casos_regioes, aes(x = Regioes, y = Casos)) +
  ...
  theme_classic() +
  scale_y_continuous(expand = c(0, 0)) +
  coord_cartesian( ylim = c(0, max(casos_regioes$Casos + 1000))) +
  labs(x = "") +
...
mortalidade_regioes_grafico <- ggplot(mortalidade_regioes, aes(x = Regiao, y = Mortalidade)) +
  geom_col(fill = "gray") +
  scale_y_continuous(expand = c(0, 0)) +
  coord_cartesian( ylim = c(0, max(mortalidade_regioes$Mortalidade + 0.01))) +
  theme_classic() +
  labs(x="") +
...
letalidade_regioes_grafico <- ggplot(letalidade_regioes, aes(x = Regiao, y = Letalidade)) +
  geom_col(fill = "gray") +
  scale_y_continuous(expand = c(0, 0)) +
  coord_cartesian( ylim = c(0, max(letalidade_regioes$Letalidade + 0.2))) +
  theme_classic() +
  labs(x = "") +
  theme(axis.text.y = element_text(size=12))
